...
def startingPage(request):
    # check for request's attributes
    # 'GET' - dict with all params of GET-request
    # 'POST' - dict with all params of POST-request
    ...
    #  '__sizeof__', '__str__', '__subclasshook__', '__weakref__', '_current_scheme_host', '_encoding', '_get_full_path',
    ...
    #  'get_port', 'get_raw_uri', 'get_signed_cookie', 'headers', 'is_ajax', 'is_secure', 'method', 'parse_file_upload',
